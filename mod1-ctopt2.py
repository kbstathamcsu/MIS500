...
plt.savefig('mod1-plot1.png')
plt.show()

#2 Generate a simple line plot
df.plot(kind='bar',x='name',y='age')
plt.savefig('mod1-plot2.png')
plt.show()
